$(document).ready(function($) {
  ...
  $(document).keyup(function(e) {
    if (e.keyCode === 27) togres.hide();
  });

  $('#resumeBox').load("resume/resume.html");
  ...
  // topButton jumps scrolling to top of page
  $('#wrapper').on('scroll', function() {
    $("#topButton").css('display', $('#wrapper').scrollTop() > 40 ? 'block' : 'none');
  });
